...
var BrightNovels = /** @class */ (function () {
    function BrightNovels() {
        var _this = this;
        this.id = 'Bright-Novels';
        this.name = 'Bright Novels';
        this.icon = 'https://raw.githubusercontent.com/MadTips/test-3/17ec7531f82df7d9c358f539bbcdb048f3a7e849/BrightNovels.jpg';
        this.site = 'https://brightnovels.com';
        this.version = '1.0.0';
        this.filters = {
            tags: {
                label: 'Tags',
    ...
    BrightNovels.prototype.ensureCoverImage = function (url) {
        return (0, isAbsoluteUrl_1.isUrlAbsolute)(url) ? url : this.site + url;
    };
    BrightNovels.prototype.popularNovels = function (pageNo_1, _a) {
    ...
    BrightNovels.prototype.parseNovel = function (novelPath_1) {
    ...
    BrightNovels.prototype.parseChapter = function (chapterPath_1) {
    ...
    BrightNovels.prototype.searchNovels = function (searchTerm_1, pageNo_1) {
...
exports.default = new BrightNovels();
